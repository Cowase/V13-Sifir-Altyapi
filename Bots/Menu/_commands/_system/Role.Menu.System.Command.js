...
const { genEmbed } = require("../../../../Main/Utils/Embed.Generator");
const Custom = require('../../../../Main/Databases/Schema/Customs/_rolemenu');
module.exports = {
    Isim: "menü",
  ...
  onRequest: async function (client, message, args) {
    if(!sistem.BOT.Owners.includes(message.member.id)) return;
                        ...
                        if(i.customId == "kur") {
                            ...
                            if(kurulcak) {
                                ...
                                kurulcak.Roles.forEach(r => {
                                    ...
                                    emoji: {id: message.guild.emojiGöster("sinirli").id},
                                value: r})
                                })
                                ...
                                message.channel.send({content: `${kurulcak.Text}`, components: [listMenu]}).then(async (oluşturuldu) => {
                                    ...
                                    collector.on('collect', async (i) => {
                                        ...
                                        Data.Roles.forEach(r => customMap.set(r, r))
                                         ...
                                         await i.reply({ content: "Rolleriniz güncellendi.", ephemeral: true }).catch(err => {})
                                    })
                                })
